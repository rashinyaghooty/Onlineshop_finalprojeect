...
class PersianCalendar:
    ...
    def __init__(self, master, x, y, date=None, width=4, distance=40):
        ...
        self.year = ttk.Combobox(master, width=width, state='readonly')
